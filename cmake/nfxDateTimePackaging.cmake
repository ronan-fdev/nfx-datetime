#==============================================================================
# nfx-datetime - Library packaging configuration (CPack)
#==============================================================================
...
if(NOT NFX_DATETIME_PACKAGE_SOURCE
		AND NOT NFX_DATETIME_PACKAGE_ARCHIVE
		AND NOT NFX_DATETIME_PACKAGE_DEB
		AND NOT NFX_DATETIME_PACKAGE_RPM
		AND NOT NFX_DATETIME_PACKAGE_WIX)
...
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY   "Modern C++20 library for high-precision date, time, and duration handling with full ISO 8601 support")
...
set(CPACK_RESOURCE_FILE_LICENSE         ${NFX_DATETIME_LICENSE_FILE})
...
if(NFX_DATETIME_PACKAGE_SOURCE)
...
set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY  "nfx-datetime")
...
if(NOT DEFINED CPACK_GENERATOR)
	...
	# --- Archive packages ---
	if(NFX_DATETIME_PACKAGE_ARCHIVE)
...
if("RPM" IN_LIST CPACK_GENERATOR AND UNIX AND NOT APPLE)
	...
	set(CPACK_RPM_PACKAGE_LICENSE       ${NFX_DATETIME_LICENSE})
...
if("WIX" IN_LIST CPACK_GENERATOR AND WIN32)
	...
	file(WRITE "${CPACK_WIX_PATCH_FILE}"
		...
		"<CPackWiXPatch>\n"
		"  <CPackWiXFragment Id=\"CM_CP_bin.nfx_datetime.dll\">\n"
